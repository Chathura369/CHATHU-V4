...
module.exports = {
  ...
  async execute(sock, msg, from, args, name, context) {
    ...
    fullMenu += themeMgr.format("box_item", { bullet: "default", content: `${prefix}yt · ${prefix}tt · ${prefix}ig` }, tCtx);
    fullMenu += themeMgr.format("box_item", { bullet: "default", content: `${prefix}fb · ${prefix}play · ${prefix}song` }, tCtx);
    fullMenu += themeMgr.format("box_item", { bullet: "default", content: `${prefix}music · ${prefix}sticker` }, tCtx);
    fullMenu += themeMgr.format("box_end", {}, tCtx);
    fullMenu += "\n";

    // --- SEARCH ---
    fullMenu += themeMgr.format("box_start", { title: "🔍 sᴇᴀʀᴄʜ & ɪɴғᴏ" }, tCtx);
    fullMenu += themeMgr.format("box_item", { bullet: "search", content: `${prefix}yts · ${prefix}g · ${prefix}wiki` }, tCtx);
    ...
    fullMenu += themeMgr.format("box_item", { bullet: "creative", content: `${prefix}aiauto · ${prefix}autoreact` }, tCtx);
    fullMenu += themeMgr.format("box_end", {}, tCtx);
    fullMenu += "\n";
    ...
    fullMenu += themeMgr.format("box_item", { bullet: "economy", content: `${prefix}buy · ${prefix}transfer` }, tCtx);
    fullMenu += themeMgr.format("box_end", {}, tCtx);
    fullMenu += "\n";
    ...
    fullMenu += themeMgr.format("box_item", { bullet: "system", content: `${prefix}status · ${prefix}autoview · ${prefix}autoreact` }, tCtx);
    fullMenu += themeMgr.format("box_item", { bullet: "system", content: `${prefix}settings · ${prefix}config · ${prefix}panel` }, tCtx);
    fullMenu += themeMgr.format("box_item", { bullet: "system", content: `${prefix}pair · ${prefix}remind · ${prefix}reminder` }, tCtx);
    fullMenu += themeMgr.format("box_end", {}, tCtx);
    fullMenu += "\n";
    ...
    fullMenu += themeMgr.format("box_item", { bullet: "owner", content: `${prefix}block · ${prefix}unblock` }, tCtx);
    fullMenu += themeMgr.format("box_item", { bullet: "owner", content: `${prefix}setowner · ${prefix}addowner · ${prefix}delowner · ${prefix}listowner` }, tCtx);
    fullMenu += themeMgr.format("box_end", {}, tCtx);
